...
//        修改个人信息
        function updateInfo() {
            ...
            $.ajax({
                ...
                success:function(msg){
                    if(msg.msg=="200"){
                        %{--parent.location = "<g:createLink controller="userInfo" action="user" />";--}%
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //弹窗
            $('#changeToTeacher').on('click', function () {
                layer.open({
                    type: 2,
                    title: ['成为教师', 'font-size:25px;text-align: center;'],
                    skin: 'demo-class',/*自定义标题颜色*/
                    closeBtn:1,/*关闭按钮风格*/
                    shadeClose: true,
                    shade: 0.8,
                    area: ['55%', '80%'],
                    content: "<g:createLink controller="userInfo" action="changeToTeacher"/>",
                    end: function(){
                    }
                });
            });
        ...
        <div class="top_container">
            ...
            <div class="top_right">
                ...
                <ul>
                    ...
                    <li class="hides_left"><a href="javascript:void(0);" id="goLogin">${userInfo.userName}</a></li>
            ...
            <div class="xxs">
                ...
                <div class="Info" id="ys">
                    <table  cellspacing="15" class="">
                        ...
                        <button id="changeToTeacher" class="q1" style="float: right;margin-top: 400px;width: 80px">成为教师</button>
                        %{--<button class="q1" style="float: right;margin-top: 400px;width: 80px"><a href="#" id="changeToTeacher">成为教师</a></button>--}%
                    </table>

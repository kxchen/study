    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#save").click(function () {
                ...
                var skjaId = $("#skjaId")[0].value;//授课教案id
                var zyxtId = $("#zyxtId")[0].value;//作业习题id
                ...
                if(courseId==""||clazzId==""||clazzName==""||skjaId==""||zyxtId==""||bjjsId==""||resourcesId==""||orderNum==""){
                    alert("请按要求上传所需资源")
            ...
            <div class="kcc" id="hh">
                ...
                <div class="nr">
                    ...
                    <div class="kzs">
                        ...
                        <!--授课教案-->
                        <div class="kzs">
                            <div class="btkz"><label>授课教案</label></div>
                            <span class="help-block" style="color:#737373">请上传授课教案</span>
                        </div>
                        <!--授课教案上传-->
                        <div class="kzss">
                                ...
                                <div class="container kv-main" style="width: 500px;">
                                    <form enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input id="skja_file" name="skja_file"  type="file" class="file"/>
                                            <input type="hidden" id="skjaId" name="teachingPlan" value="${teachingPlan?.id}" />
                                            <script>
                                                $("#skja_file").fileinput({
                                                    language: "zh",
...
//                                                    allowedFileExtensions: ["jpg", "png", "gif","mp4"],
                                                    uploadExtraData:{
                                                        ...
                                                        purpose:'teachingPlan'
                                                    }

                                                    <g:if test="${teachingPlan?.preImgPath}">
                                                    ,initialPreview:[
                                                        "<img  src='${resource(dir: '', file: teachingPlan.preImgPath)}' class='file-preview-image' alt='${teachingPlan?.name}' title='${teachingPlan?.name}'>"
                                                    ],
                                                    initialPreviewConfig: [
                                                        {
                                                            caption: "${teachingPlan?.name}",
                                                            size: "${teachingPlan?.fileSize}",
                                                            url: "${createLink(controller:'courseInfo', action:'delete', id: teachingPlan?.id)}",
                                                            key: "${teachingPlan.id}"
                                                        }
                                                    ]
                                                    </g:if>
                        ...
                        <!--作业习题-->
                        <div class="kzs">
                            <div class="btkz"><label>作业习题</label></div>
                            <span class="help-block" style="color:#737373">请上传作业习题</span>
                        </div>
                        <!--作业习题-->
                        <div class="kzss">
                            <div class="btkz"><label></label></div>
                            <div class="uplo">
                                <div class="container kv-main" style="width: 500px;">
                                    <form enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input id="zyxt_file" name="zyxt_file"  type="file" class="file"/>
                                            <input type="hidden" id="zyxtId" name="homework" value="${homework?.id}" />
                                            <script>
                                                $("#zyxt_file").fileinput({
                                                    language: "zh",
                                                    uploadUrl: '<g:createLink controller="resourceInfo" action="upload"/>', //上传的地址
...
//                                                    allowedFileExtensions: ["jpg", "png", "gif","mp4"],
                                                    ...
                                                    <g:if test="${homework?.preImgPath}">
                                                    ,initialPreview:[
                                                        "<img  src='${resource(dir: '', file: homework.preImgPath)}' class='file-preview-image' alt='${homework?.name}' title='${homework?.name}'>"
                                                    ],
                                                    initialPreviewConfig: [
                                                        {
                                                            caption: "${homework?.name}",
                                                            size: "${homework?.fileSize}",
                                                            url: "${createLink(controller:'courseInfo', action:'delete', id: homework?.id)}",
                                                            key: "${homework.id}"
                                                        }
                                                    ]
                                                    </g:if>
                        ...
                        <div class="kzs">
                            ...
                            <span class="help-block" style="color:#737373">请上传本讲介绍</span>
                        </div>
                        <!--本讲介绍上传-->
                        <div class="kzss">
                            <div class="btkz"><label></label></div>
                                ...
                                <div class="container kv-main" style="width: 500px;">
                                    <form enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="bjjsId" name="jieShao" value="${jieShao?.id}" />
                                            <script>
                                                $("#bjjs_file").fileinput({
                                                    language: "zh",
                                                    uploadUrl: '<g:createLink controller="resourceInfo" action="upload"/>', //上传的地址
...
//                                                    allowedFileExtensions: ["jpg", "png", "gif","mp4"],
                    ...
                    <div class="kzs">
                        ...
                        <span class="help-block" style="color:#737373">视频、文件等</span>
                    </div>
                    <!--资源上传-->
                    <div class="kzss">
                        <div class="btkz"><label></label></div>
                        <div class="uplo">
                            <div class="container kv-main" style="width: 500px;">
                                <form enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input id="resources_file" name="resources_file"  type="file" class="file" multiple/>
                                        <input type="hidden" id="resourcesId" name="resources.d" value="" />
                                        <script>
...
//                                                    allowedFileExtensions: ["jpg", "png", "gif","mp4"],
                                                ...
                                                <g:if test="${resourceInfoVList?.size()!=0}">
                                                    <g:each in="${resourceInfoVList}" status="i" var="resourceInfoV">
                                                        ,initialPreview:[
                                                            "<img  src='${resource(dir: '', file: resourceInfoV.preImgPath)}' class='file-preview-image' alt='${resourceInfoV?.name}' title='${resourceInfoV?.name}'>"
                                                        ],
                                                        initialPreviewConfig: [
                                                            {
                                                                caption: "${resourceInfoV?.name}",
                                                                size: "${resourceInfoV?.fileSize}",
                                                                url: "${createLink(controller:'courseInfo', action:'delete', id: resourceInfoV?.id)}",
                                                                key: "${resourceInfoV.id}"
                                                            }
                                                        ]
                                                    </g:each>
                                                </g:if>

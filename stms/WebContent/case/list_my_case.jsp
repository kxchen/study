...
<div class="right-box container-fluid top-h">
         ...
         <form class="bs-example bs-example-form" role="form" action="<c:url value="/CaseAction"></c:url>" method="get">
                <div class="row">
                    <div class="col-xs-5 pull-right">
                        ...
                        <input type="hidden" name="operate" value="listMyCase">
            ...
            <ul class="table-ul col-xs-12">
             <c:forEach items="${caseList}" var="caseInfo" varStatus="idx" >
                <li>
                    ...
                    <table>
                        <tr>
                            <td  width="10%">${idx.index+1}</td>
                            <td  width="50%"  class="quantitys">${caseInfo.caseName }</td>
	...
	<c:if test="${pageNo > 1 }">
		<li><a href="<c:url value='/CaseAction?operate=listMyCase&search=${search}&pageNo=${pageNo-1 }'/>">&laquo;</a></li>
	</c:if>
	...
	<c:forEach begin="${begin }" end="${end }" var="i">
	  <c:choose>
	  	...
	  	<c:otherwise>
	  		<li><a href="<c:url value='/CaseAction?operate=listMyCase&search=${search}&pageNo=${i}'/>">${i }</a></li>
	  	</c:otherwise>
	  </c:choose>
	</c:forEach>
	...
	<c:if test="${pageNo < totalPage }">　
		<li><a href="<c:url value='/CaseAction?operate=listMyCase&search=${search}&pageNo=${pageNo+1 }'/>">&raquo;</a></li>
	</c:if>
</ul>　
    </div>
</div>

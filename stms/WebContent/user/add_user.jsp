...
<body>
    ...
    <div class="col-xs-10 col-xs-offset-1 ">
        <div id="upload-table" class="upload-table">
            <h2 class="text-left font-size">新建用户</h2>
            <hr>
        </div>
        <form class="form-horizontal col-xs-12" role="form" method="post" id="addUserForm">
            <div class="form-group updatePwd">
                ...
                <div class="col-xs-8">
                	<div class="prompt" id="text">
	                </div>
                    <input type="text" class="form-control" id="name" name="userName" value="" placeholder="请输入姓名" required>
                </div>
            </div>
            <div class="form-group updatePwd">
                <label for="account" class="col-xs-3 control-label">账号：</label>
                <div class="col-xs-8" style="position: relative">
                    <input type="text" class="form-control" id="account"  name="phone" placeholder="请输入手机号">
                </div>
            </div>
            <div class="form-group updatePwd">
                <label for="password" class="col-xs-3 control-label">密码：</label>
                <div class="col-xs-8">
                	<div class="prompt" id="password_info">
                		请输入密码
	                </div>
            ...
            <div class="form-group updatePwd">
             ...
             <div class="form-group updatePwd" style="margin-bottom: -10px">
            ...
            <div class="updateBtn pull-right" data-toggle="buttons">
                <hr>
                <label class="center-block">
                    <button type="button" class="btn btn-primary" onclick="doAddUser()">确   定</button>
...
function doAddUser() {
	 ...
	 $.ajax({
			...
			type:'post',
			dataType:'json',
			data:{operate:"doAddUser",userName:user_name,phone:phone,password:password,roleId:role_id,departmentId:department_id,state:state},

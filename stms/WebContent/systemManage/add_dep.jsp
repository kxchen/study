...
<div class="container ">
    <div class="col-xs-12 ">
        <div id="upload-table">
            <h2 class="text-left font-size">新建部门</h2>
            <hr>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 pull-right">
                            <div class="input-group">
                                <input type="text" class="form-control" name="depName" id="depName" placeholder="请输入部门名称">
                                <div class="input-group-btn" onclick="doAddDep()">
	...
	function doAddDep() {
		...
		if(departmentName.length==0){  
		 ...
		 $.ajax({
				...
				type:'post',
				dataType:'json',
				data:{operate:"doAddDep",departmentName:departmentName},

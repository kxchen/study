...
<h1>搜索结果业</h1>
	<%
		ArrayList<StudentInfo> studentInfoListByName = (ArrayList<StudentInfo>) request
				.getAttribute("studentInfoListByName");
	%>
	...
	<table>
		...
		%>
		<%
			for (int i = 0; i < studentInfoListByName.size(); i++) {
					StudentInfo studentInfo = studentInfoListByName.get(i);
		%>
		<tr>
			<td><%=i + 1%></td>

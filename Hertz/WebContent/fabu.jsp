...
<ul class="rz_two rz_four">
	<li><p><img src="img/img_17.png">车主姓名：</p><input type="text" class="txt" value="${userInfo.userName}" readonly></li>
    <li><p><img src="img/img_18.png">手机号码：</p><input type="text" class="txt" value="${userInfo.phone}"readonly></li>
    <li><p><img src="img/img_19.png">身份证号：</p><input type="text" class="txt" value="${userInfo.idNum}" readonly></li>
</ul>
<h3 class="rz_one">

...
<body class="body">
	...
	<ul class="xx_one">
		<li><i><img src="img/img_21.png">品牌：</i>
			<p>${carInfo.brand}(${carInfo.model})</p></li>
		<li><i><img src="img/img_22.png">颜色：</i>
			<p>${carInfo.color}</p></li>
		<li><i><img src="img/img_33.png">座位：</i>
			<p>${carInfo.seats}</p></li>
		<li><i><img src="img/img_25.png">排量：</i>
			<p>${carInfo.cc}</p></li>
		<li><i><img src="img/img_28.png">排挡：</i>
			<p>${carInfo.gears}</p></li>
		<li><i><img src="img/img_34.png">公里数：</i>
			<p>${carInfo.km}公里</p></li>
	</ul>
	<div class="xx_two">
		<div class="nr">
			<img src="img/02.png"> <img src="img/02.png"> <img
				src="img/02.png"> <img src="img/02.png">
		</div>
	</div>
	<form action=" <c:url value="UserAction"></c:url>">
		...
		<div class="xx_three">
			...
			<p>
				<i>租价：</i> <strong>${carInfo.price}</strong> <em>元/天</em>
			</p>
		</div>
		<div class="xx_four">
